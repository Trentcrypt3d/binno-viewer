...
export function CarouselCustomNavigation() {
  return (
    <Carousel
      className="rounded-xl relative w-full h-full max-h-min overflow-y-scroll"
      prevArrow={() => null}
      nextArrow={() => null}
  ...
  />
          ...
          <div className="flex justify-end hover-effect">
  <img
  ...
  <span className="opacity-50 block cursor-pointer transition-all text-white mt-1 mr-4">Sign-in</span>
</div>
