...
<div className="w-full bg-gray-500">
    ...
    />
          ...
          <div className="absolute bottom-1/4 left-6 transform translate-y-2">
            <div className="App mb-5">
              <CardContainer imageUrls={imageUrls} />
            </div>
          </div>
            <svg className="block mx-auto" width="auto" height="auto" viewBox="0 0 1440 650" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect y="346" width="1440" height="304" fill="white"/>
              <path d="M1015.5 202.5L1440 0V346H701L1015.5 202.5Z" fill="white"/>
            </svg>
          </div>
